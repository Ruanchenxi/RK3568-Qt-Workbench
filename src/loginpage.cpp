 ...
 * @brief 登录成功回调
 */
void LoginPage::onLoginSucceeded(const QJsonObject &userInfo)
{
    QString username = userInfo.value("user_name").toString();
    QString roleName = userInfo.value("role_name").toString();
