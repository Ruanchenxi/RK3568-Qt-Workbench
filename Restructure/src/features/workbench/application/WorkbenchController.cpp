...
bool WorkbenchController::buildTargetUrl(QUrl *url, QString *safeSummary, QString *error) const
{
    ...
    if (!accessToken.isEmpty()) {
        *url = baseUrl;
        ...
        // Some remote third-api deployments return only access_token. The
        // workbench SSO entry should still be used instead of falling back to
        // the public web login page.
